 ...
 *   food   = cafe / restaurant / market  (cup icon)  <-- added beyond your 4;
 *            many branch spots are food/drink, easy to fold into 'scenic' if
 *            you'd rather keep the legend to 4 icons.
 * ========================================================================== */
...
window.CDANS_DATA = {
  ...
  basemap: { url: "assets/map-base.svg", w: 825, h: 311 },
  ...
  pixels: {
    ...
    "raging-crow": [266, 116], "ns-spirit": [477, 134]
  },
  ...
  distilleries: [
    {
      ...
      image: "assets/bottles/boatskeg.png",
      ...
      pois: [
        { name: "Dennis Point Café", cat: "food", lat: 43.5940, lng: -65.7560, approx: true, url: "https://www.facebook.com/DennisPointCafe/?locale=fr_FR" },
        { name: "West Pubnico Golf Course", cat: "scenic", lat: 43.6260, lng: -65.7430, approx: true, url: "https://www.westpubnicogolf.com/" },
        { name: "Red Cap Restaurant & Motel", cat: "stay", lat: 43.6300, lng: -65.7560, approx: true, url: "https://redcaprestaurantandmotel.com/" }
      ]
    },
    {
      ...
      image: "assets/bottles/still-fired.png",
      ...
      pois: [
        { name: "Whiskey Teller (next to Fortview Golf)", cat: "food", lat: 44.7480, lng: -65.5200, approx: true, url: null },
        { name: "Mickey Hill Provincial Park Trail", cat: "hike", lat: 44.6900, lng: -65.2000, approx: true, url: "https://novascotia.com/listing/mickey-hill-provincial-park/" },
        { name: "Fort Anne National Historic Site", cat: "scenic", lat: 44.7420, lng: -65.5180, approx: true, url: "https://novascotia.com/listing/fort-anne-national-historic-site/" }
      ]
    },
    {
      ...
      image: "assets/bottles/barrelling-tide.png",
      ...
      pois: [
        { name: "Fox Hill Cheese House", cat: "food", lat: 45.1030, lng: -64.4170, approx: true, url: "https://www.foxhillcheesehouse.com/" },
        { name: "Blomidon Provincial Park", cat: "hike", lat: 45.2580, lng: -64.3490, approx: true, url: "https://parks.novascotia.ca/park/blomidon" },
        { name: "Old Orchard Inn | Terroir Restaurant", cat: "stay", lat: 45.0930, lng: -64.3270, approx: true, url: "https://oldorchardinn.com/" }
      ]
    },
    {
      ...
      image: "assets/bottles/james-roue.png",
      ...
      pois: [
        { name: "Walkers Restaurant", cat: "food", lat: 44.9880, lng: -64.1360, approx: true, url: "https://www.walkersrestaurant.ca/" },
        { name: "Clifton Museum Park Circular", cat: "scenic", lat: 44.9930, lng: -64.1450, approx: true, url: "https://clifton.novascotia.ca/" },
        { name: "Birthplace of Hockey Museum", cat: "scenic", lat: 44.9870, lng: -64.1390, approx: true, url: "https://birthplaceofhockey.ca/" }
      ]
    },
    {
      ...
      image: "assets/bottles/cherry-tree.png",
      ...
      pois: [
        { name: "Gerrish & Gray Café", cat: "food", lat: 44.9900, lng: -64.1390, approx: true, url: "https://www.gerrishandgray.ca/" },
        { name: "Lake Pisiquid Loop", cat: "hike", lat: 44.9820, lng: -64.1310, approx: true, url: null },
        { name: "Geldert Guest House B&B", cat: "stay", lat: 44.9950, lng: -64.1420, approx: true, url: "https://geldertguesthouse.com/" }
      ]
    },
    {
      ...
      image: "assets/bottles/ironworks.png",
      ...
      pois: [
        { name: "The Grand Banker", cat: "food", lat: 44.3760, lng: -64.3150, approx: true, url: "https://grandbanker.com/" },
        { name: "Lunenburg Walking Tours", cat: "scenic", lat: 44.3770, lng: -64.3170, approx: true, url: "https://www.lunenburgwalkingtours.com/" },
        { name: "Bluenose II", cat: "scenic", lat: 44.3750, lng: -64.3140, approx: true, url: "https://bluenose.novascotia.ca/" }
      ]
    },
    {
      ...
      image: "assets/bottles/compass.png",
      ...
      pois: [
        { name: "Fort Needham Memorial Park", cat: "scenic", lat: 44.6620, lng: -63.5980, approx: true, url: "https://novascotia.com/listing/fort-needham-memorial-park/" },
        { name: "Compass Tower Airbnb", cat: "stay", lat: 44.6578, lng: -63.5938, approx: true, url: "https://www.airbnb.ca/rooms/17407394" }
      ]
    },
    {
      ...
      image: "assets/bottles/coldstream.png",
      ...
      pois: [
        { name: "John Crawford Trail (Stewiacke)", cat: "hike", lat: 45.1430, lng: -63.3490, approx: true, url: "https://www.stewiacke.net/trails.html" }
      ]
    },
    {
      ...
      image: "assets/bottles/caldera.png",
      ...
      pois: [
        { name: "Megs Cove Beach Trail", cat: "hike", lat: 45.7800, lng: -63.0500, approx: true, url: null }
      ]
    },
    {
      ...
      image: "assets/bottles/steinhart.png",
      ...
      pois: [
        { name: "Keppoch Mountain Trail System", cat: "hike", lat: 45.5630, lng: -62.0190, approx: true, url: "https://www.thekeppoch.ca/" }
      ]
    },
    {
      ...
      image: "assets/bottles/below-the-salt.png",
      ...
      pois: [
        { name: "GH Smith & Sons General Store", cat: "food", lat: 45.6200, lng: -61.3600, approx: true, url: "https://www.facebook.com/p/Smith-G-H-Son-General-Store-100020686196817/" },
        { name: "Port Hawkesbury Community Trails", cat: "hike", lat: 45.6080, lng: -61.3580, approx: true, url: "https://novascotia.com/listing/port-hawkesbury-community-trails/" },
        { name: "Canso Causeway", cat: "scenic", lat: 45.6470, lng: -61.4180, approx: true, url: null }
      ]
    },
    {
      ...
      image: "assets/bottles/glenora.png",
      ...
      pois: [
        { name: "MacKinnons Brook Trail", cat: "hike", lat: 46.1300, lng: -61.4200, approx: true, url: null }
      ]
    },
    {
      ...
      image: "assets/bottles/black-harbour.png",
      ...
      pois: [
        { name: "Hubbards Barn Farmers' Market", cat: "food", lat: 44.6360, lng: -64.0640, approx: true, url: "https://hubbardsbarn.org/" },
        { name: "Aspotogan Golf Course", cat: "scenic", lat: 44.6050, lng: -64.0290, approx: true, url: "https://aspotoganridge.com/" },
        { name: "The Tuna Blue Inn & Restaurant", cat: "stay", lat: 44.6320, lng: -64.0660, approx: true, url: "https://www.tunablue.ca/" }
      ]
    },
    {
      ...
      image: "assets/bottles/north-mountain.png",
      ...
      pois: [
        { name: "Pockwock Falls Trail", cat: "hike", lat: 44.8000, lng: -63.8600, approx: true, url: null }
      ]
    },
    {
      ...
      image: "assets/bottles/good-robot.png",
      ...
      pois: [
        { name: "Chain Yard Cider", cat: "food", lat: 44.6580, lng: -63.5870, approx: true, url: "https://www.chainyardcider.com/" },
        { name: "Halifax Common", cat: "scenic", lat: 44.6510, lng: -63.5870, approx: true, url: "https://discoverhalifaxns.com/venues/halifax-commons/" },
        { name: "Brewery Park Hotel", cat: "stay", lat: 44.6470, lng: -63.5760, approx: true, url: "https://brewerypark.ca/" }
      ]
    },
    {
      num: 16, slug: "raging-crow", name: "Raging Crow Distillery",
      lat: 45.1620, lng: -64.4130,
      address: "969 Seminary Ave, Canning, NS, B0P 1H0",
      image: "assets/bottles/raging-crow.png",
      desc: "This distillery showcases Annapolis Valley ingredients in creative, small-batch spirits. Down-to-earth and proudly inclusive, it's a place to discover new flavours and feel right at home.",
      pois: [
        { name: "The Long Table Social Club", cat: "food", lat: 45.1620, lng: -64.4130, approx: true, url: "https://www.thelongtablesocialclub.com/" },
        { name: "Where It's At Tours", cat: "scenic", lat: 45.1640, lng: -64.4150, approx: true, url: "https://www.whereitsattours.com/" },
        { name: "Two Planks and a Passion", cat: "scenic", lat: 45.1800, lng: -64.4200, approx: true, url: "https://artscentre.ca/two-planks/" }
      ]
    },
    {
      ...
      image: "assets/bottles/ns-spirit.png",
      ...
      pois: [
        { name: "Albion Trail", cat: "hike", lat: 45.5560, lng: -62.6660, approx: true, url: "https://novascotia.com/listing/albion-trail/" }
      ]
    }
  ]
};
